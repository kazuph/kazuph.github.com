...
## つまり
> 数えればなんとかなるんだけど、人の手でやるとめちゃくちゃ時間がかかるので、コンピュータにやらせる方が速い問題

## もしくは
> 数学を駆使するとものすごく速くとける問題
### こんな問題が<br />400問以上
### お姉さんに見せたら<br />大変なことによ！？
### これ以上お姉さんに数えさせちゃいけない！！
## こんなことになってしまう前に！
...
### 翌週からJenkinsさん雇われてた(^q^)

## Euler System
![pjeuler](./img/pjeulercom.png)

### そんな感じで楽しい「ぷろおい」生活が始まる
